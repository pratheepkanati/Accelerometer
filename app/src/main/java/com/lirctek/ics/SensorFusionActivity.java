...
//            if(xAccCalibrated<-3.0f){
//                Snackbar.make(findViewById(R.id.root_la), "Harsh Break", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
//            }
//            else if(xAccCalibrated>3.0f){
//                Snackbar.make(findViewById(R.id.root_la), "Harsh Accerleration", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
//            }
//            if(yAccCalibrated<-3.0f){
//                Snackbar.make(findViewById(R.id.root_la), "Hard Left Turn", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
//            }
//            else if(yAccCalibrated>3.0f){
//                Snackbar.make(findViewById(R.id.root_la), "Hard Right Turn", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
//            }
//
//            if(zAccCalibrated<-8.0f){
//                Snackbar.make(findViewById(R.id.root_la), "Hard Down Bump", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
//            }
//            else if(zAccCalibrated>11.0f){
//                Snackbar.make(findViewById(R.id.root_la), "Hard Up Bump", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
//            }
